...
const calculateAreaOfRectangle = (a,b) => a * b;

let s = calculateAreaOfRectangle(5, 8)
console.log(s)

// створити функцію яка обчислює та повертає площу кола з радіусом r
const calculateAreaOfRound = (radius) => `The area of round is ${Math.floor(Math.PI * radius ** 2)} cm2`;
let areaOfRound = calculateAreaOfRound(8);
console.log(areaOfRound);

// створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
const calculateAreaOfCylinder = (h, radius) => `The area of Cylinder is ${Math.floor(2 * Math.PI * radius * (h + radius))} m2`;
...
const createRandomList = (listText, numberOfList) => {
    document.write('<ul>');
...
const createListOfElementFromArray = (array) => {
    document.write('<ul>');
